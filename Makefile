...
clean:
	@rm -r $(addprefix $(obj_path)/,$(obj)) $(obj_path)/ft_printf
...
.obj/logf_intern.o: src/logf_intern.c includes/logf.h includes/libft.h
...
.obj/ft_readfile.o: src/ft_readfile.c includes/libft.h
